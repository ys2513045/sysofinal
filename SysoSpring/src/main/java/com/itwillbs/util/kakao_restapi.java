...
public class kakao_restapi {
    ...
    public String getAccessToken (String authorize_code) {
        ...
        try {
            ...
            sb.append("&client_id=8a186887660b8f9049299861425b447a");
            sb.append("&redirect_uri=http://localhost:8080/syso/oauth");
...
//            JsonObject profile = element.getAsJsonObject().get("profile").getAsJsonObject();
            ...
            JsonObject getImgUrl = kakao_account.getAsJsonObject().get("profile").getAsJsonObject();
           ...
           String member_id = element.getAsJsonObject().get("id").getAsString();
            ...
            String shop_profilePhoto = getImgUrl.getAsJsonObject().get("profile_image_url").getAsString();
            
            userInfo.put("member_nickname", member_nickname);
            userInfo.put("member_email", member_email);
            userInfo.put("member_id", member_id);
            userInfo.put("shop_profilePhoto", shop_profilePhoto);
//            userInfo.put("shop_profilePhoto", shop_profilePhoto);
